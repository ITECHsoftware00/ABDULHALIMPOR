  ...
  return (
    <div className="min-h-screen bg-main text-sec pt-32 pb-24 px-6 md:px-20 relative overflow-hidden print:p-0 print:bg-white print:text-black">
      ...
      <motion.div
        ...
        className="max-w-5xl mx-auto bg-card-bg/30 backdrop-blur-xl border-2 border-muted/10 rounded-[4rem] overflow-hidden shadow-2xl print:shadow-none print:border-none print:rounded-none print:max-w-full"
      >
