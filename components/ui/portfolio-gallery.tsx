...
export function PortfolioGallery({
    ...
    return (
        <section
            ...
            id="archives"
        >
            <div className="max-w-7xl mx-auto bg-main/50 backdrop-blur-sm rounded-2xl border border-muted/20 overflow-hidden">
                {/* Header Section */}
                <div className="relative z-10 text-center pt-16 pb-8 px-8">
                    <h2 className="text-4xl md:text-6xl font-space font-black text-sec mb-8 text-balance uppercase tracking-tighter">{title}</h2>

                    <Link
                        to={archiveButton.href}
                        className="interactive inline-flex items-center gap-3 bg-sec text-main px-6 py-3 rounded-full font-bold hover:bg-sec/90 transition-colors group mb-20 uppercase tracking-widest text-sm"
                    >
                    ...
                    <div className={`flex ${spacing} pb-8 pt-40 items-end justify-center`}>
                        {images.map((image, index) => {
                            ...
                            return (
                                <motion.div
                                    key={index}
                                    className="interactive group cursor-pointer flex-shrink-0"
                                    style={{
                                        zIndex: zIndex,
                                    }}
                                    initial={{
                                ...
                                >
                                    <div
                                        className="relative aspect-video w-64 md:w-80 lg:w-96 rounded-2xl overflow-hidden transition-transform duration-300 group-hover:scale-105 border-[3px] border-muted/20 group-hover:border-thr/50"
                                        style={{
                                            boxShadow: `
                      ...
                      `,
                                    ...
                                    >
                                        ...
                                        />
                                        {image.title && (
                                            <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-main/90 to-transparent">
                        ...
                        {Array(marqueeRepeat)
                            ...
                            .map((_, i) => (
                                ...
                                >
                                    {images.map((image, index) => (
                                        ...
                                        >
                                            <div
                                                className="relative aspect-video w-64 rounded-2xl overflow-hidden transition-transform duration-300 group-hover:scale-105 border-[3px] border-muted/20 hover:border-thr/50"
                                                style={{
                                                    boxShadow: `
                            rgba(0, 0, 0, 0.01) 0.796192px 0px 0.796192px 0px,
                            rgba(0, 0, 0, 0.03) 2.41451px 0px 2.41451px 0px,
                          ...
                          `,
                                            ...
                                            >
                                                ...
                                                />
                                                {image.title && (
                                                    <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-main/90 to-transparent flex items-end">
