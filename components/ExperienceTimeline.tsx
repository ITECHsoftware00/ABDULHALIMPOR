            ...
            {EXPERIENCES.map((exp, idx) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-8 h-8 rounded-full border-4 border-sec z-10"
                  style={{ background: 'linear-gradient(135deg, #8b5cf6, #22d3ee)', boxShadow: '0 0 30px rgba(139,92,246,0.8)' }}
                ></motion.div>
