      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          <motion.div
            ...
            className="relative group rounded-[3rem] overflow-hidden border-4 border-muted/10 shadow-2xl"
          >
        ...
        <div className="mt-40 grid grid-cols-1 md:grid-cols-2 gap-24">
          <motion.div
            ...
            className="bg-card-bg p-12 md:p-16 rounded-[4rem] border-2 border-muted/5 shadow-xl"
          >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="mt-40 pt-24 border-t-2 border-muted/10 text-center"
        >
